...
namespace BC7.Business.Implementation.Tests.Integration.Tests.BuyingPositionInMatrix
{
    ...
    public class BuyPositionInMatrixTest : BaseIntegration
    {
        ...
        [Given(StepTitle = "And given created default accounts and matrix in database")]
        async Task CreateUserAndMultiAccountAndMatrixPositionsInDatabase()
        {
        ...
        [Given(StepTitle = "And given command")]
        void AndGivenCommand()
        {
        ...
        void ThanTheResultShouldBeGuidWithMatrixPositionBought()
        {
