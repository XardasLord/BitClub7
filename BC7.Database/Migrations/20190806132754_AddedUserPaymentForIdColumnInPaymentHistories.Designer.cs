...
namespace BC7.Database.Migrations
{
    ...
    [Migration("20190806132754_AddedUserPaymentForIdColumnInPaymentHistories")]
    partial class AddedUserPaymentForIdColumnInPaymentHistories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BC7.Domain.PaymentHistory", b =>
                {
                    ...
                    b.Property<Guid>("UserPaymentForId");
            ...
            modelBuilder.Entity("BC7.Domain.Withdrawal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("PaymentSystemType");

                    b.Property<Guid>("UserMultiAccountId");

                    b.Property<string>("WithdrawalFor");
            ...
            modelBuilder.Entity("BC7.Domain.Withdrawal", b =>
                {
                    b.HasOne("BC7.Domain.UserMultiAccount", "UserMultiAccount")
                        .WithMany()
                        .HasForeignKey("UserMultiAccountId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
